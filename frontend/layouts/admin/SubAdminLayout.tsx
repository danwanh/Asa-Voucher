...
export function SubAdminLayout({ user, role, page, navItems, onNavigate, onLogout, onSwitchRole, basePath, children }: Props) {
        ...
        {navItems.map((n) => {
          ...
          return (
            <button
              ...
              onClick={() => {
                onNavigate(n.pg)
                router.push(n.pg === "dashboard" ? basePath : `${basePath}/${n.pg}`)
                setMobileOpen(false)
              }}
