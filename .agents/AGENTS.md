...
## Communication
- Always begin every answer with exactly `Hi!`.
...
- After every change, run the relevant checks and report the exact command and result.
- Always report every changed file and summarize what changed in each file.
